...
-   Access the servlet at <a href="http://localhost:5990/refapp/plugins/servlet/todo/list" class="uri external-link">localhost:5990/refapp/plugins/servlet/todo/list</a>, you will need to be logged in now, for example as `admin (pwd:admin)`
...
-   Access the servlet at <a href="http://localhost:5990/refapp/plugins/servlet/todo/list" class="uri external-link">localhost:5990/refapp/plugins/servlet/todo/list</a>, you will need to be logged in now:
