...
<p>See the plugin framework guide to <a href="/server/framework/atlassian-sdk/creating-plugin-module-instances-851984.html">creating plugin module instances</a>.</p>
...
<p>It can be used in a way similar to <a href="/server/framework/atlassian-sdk/adding-resources-to-your-project-852004.html">normal resources</a>,</p>
...
The template rendering system is extensible. You can add custom renderers by creating plugins. For more information on this, check out the [Web Panel Renderer Plugin Module](/server/framework/atlassian-sdk/web-panel-renderer-plugin-module-852106.html).
