...
<tr class="even">
<td><p>Changed:</p></td>
<td><p><strong>Web resource contexts</strong> became available in <a href="https://developer.atlassian.com/display/ARCHIVES/Plugin+Framework+2.5+Release+Notes">Atlassian Plugin Framework 2.5</a> and later. Before that they were available in Confluence only, in Confluence 2.10 and later.<br />
<strong>Web resource transformers</strong> became available in <a href="https://developer.atlassian.com/display/ARCHIVES/Plugin+Framework+2.5+Release+Notes">Atlassian Plugin Framework 2.5</a> and later.<br />
