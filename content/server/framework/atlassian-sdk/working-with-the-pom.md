...
In general, our sample POM uses standard Maven object model syntax, as described here <a href="http://maven.apache.org/pom.html" class="uri external-link">maven.apache.org/pom.html</a>. However, it's worth looking at how the SDK generates the POM for a specific project:
