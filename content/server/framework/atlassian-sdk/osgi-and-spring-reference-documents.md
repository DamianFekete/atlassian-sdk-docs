...
<td><p>Introduction to OSGi: problem, solution, framework, services.</p></td>
<td><p><a href="http://www.osgi.org/Main/HomePage" class="external-link">OSGi Alliance</a></p></td>
</tr>
<tr class="even">
<td><p><a href="http://www.osgi.org/About/HowOSGi" class="external-link">How to get Started with OSGi</a></p></td>
<td><p>Links to OSGi tutorials for various environments, for developers who want to delve into OSGi.</p></td>
<td><p><a href="http://www.osgi.org/Main/HomePage" class="external-link">OSGi Alliance</a></p></td>
</tr>
<tr class="odd">
...
<td><p>This is part 1 of a three-part introduction to OSGi. It gets you started with OSGi development concepts and shows you how to build a simple Hello World application using the Eclipse OSGi container implementation, Equinox.</p></td>
<td><p><a href="http://www.javaworld.com/" class="external-link">JavaWorld</a></p></td>
</tr>
<tr class="odd">
...
<td><p>Part 2 of the above series.</p></td>
<td><p> </p></td>
</tr>
<tr class="even">
...
<td><p>Part 3 of the above series.</p></td>
<td><p> </p></td>
</tr>
<tr class="odd">
...
<td><p>The reference guide for Spring DM: concepts, the syntax for the OSGi Service Platform based namespaces, the Dynamic Modules extender bundle and the OSGi manifest header entries defined by Dynamic Modules.</p></td>
<td><p><a href="http://www.springsource.com/" class="external-link">spring source</a></p></td>
</tr>
<tr class="even">
<td><p><a href="http://blog.springsource.com/2008/02/18/creating-osgi-bundles/" class="external-link">Creating OSGi bundles</a></p></td>
<td><p>Blog post on what a bundle actually is and how a vanilla JAR can be transformed into an OSGi bundle.</p></td>
<td><p><a href="http://www.springsource.com/" class="external-link">spring source</a></p></td>
</tr>
<tr class="odd">
<td><p><a href="http://www.aqute.biz/Code/Bnd" class="external-link">Bnd - Bundle Tool</a></p></td>
<td><p>A description of the <strong>bnd</strong> tool used by the Atlassian Plugin Framework to generate bundles.</p></td>
<td><p><a href="http://www.aqute.biz/" class="external-link">aQute</a></p></td>
</tr>
</tbody>
</table>
