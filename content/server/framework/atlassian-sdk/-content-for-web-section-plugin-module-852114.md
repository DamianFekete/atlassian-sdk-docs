---
title: Content for Web Section Plugin Module 852114
aliases:
...
subcategory:
---
# Documentation : \_Content for Web Section Plugin Module

## Purpose of this Module Type

Web Section plugin modules allow plugins to define new sections in application menus. Each section can contain one or more links. To insert the links themselves, see the [Web Item Plugin Module](/server/framework/atlassian-sdk/web-item-plugin-module-852014.html).
