...
See the detailed <a href="/server/framework/atlassian-sdk/atlas-help" class="createlink">guide to all scripts</a>.

##### RELATED TOPICS

[Working with the SDK](/server/framework/atlassian-sdk/working-with-the-sdk)  
<a href="/server/framework/atlassian-sdk/atlas-help/" class="createlink">Developing your Plugin using the Atlassian Plugin SDK</a>
