...
-   [Build Failure - Manifest Validation Errors](https://developer.atlassian.com/display/DOCS/Build+Failure+-+Manifest+Validation+Errors)
-   [Cannot Log In to Confluence using Admin Account](https://developer.atlassian.com/display/DOCS/Cannot+Log+In+to+Confluence+using+Admin+Account)
-   [Choosing a Logging Framework](https://developer.atlassian.com/display/DOCS/Choosing+a+Logging+Framework)
-   [Choosing a Package Name](https://developer.atlassian.com/display/DOCS/Choosing+a+Package+Name)
-   [Eclipse Maven Plugin Build Error](https://developer.atlassian.com/display/DOCS/Eclipse+Maven+Plugin+Build+Error)
-   [If you change pom.xml, you may need to restart the atlas-cli](https://developer.atlassian.com/display/DOCS/If+you+change+pom.xml%2C+you+may+need+to+restart+the+atlas-cli)
-   [Instant Loading of Plugin Resources](https://developer.atlassian.com/display/DOCS/Instant+Loading+of+Plugin+Resources)
-   [Overriding the application's webapp when developing your plugin](https://developer.atlassian.com/display/DOCS/Overriding+the+application%27s+webapp+when+developing+your+plugin)
-   [Specifying a particular version of the host application](https://developer.atlassian.com/display/DOCS/Specifying+a+particular+version+of+the+host+application)
-   [Tips for Functional Tests with Selenium](https://developer.atlassian.com/display/DOCS/Tips+for+Functional+Tests+with+Selenium)
-   [Using the Atlassian Plugin SDK with a Source Code License](https://developer.atlassian.com/display/DOCS/Using+the+Atlassian+Plugin+SDK+with+a+Source+Code+License)
-   [Using your own log4j configuration for your plugin](https://developer.atlassian.com/display/DOCS/Using+your+own+log4j+configuration+for+your+plugin)
